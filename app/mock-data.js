...
var mock = function (app) {
    ...
    // Creates a profile
    app.post('/imperial/profiles', function (req, res, next) {
        var profile = req.body.data.items[0];
        if (!profile.name || !profile.password || !profile.email) {
            res.setHeader('content-type', 'application/json');
            res.statusCode = 400;
    ...
    // Gets a profile
    app.get('/imperial/profiles/:code', function (req, res, next) {
        if (req.params.code == 'user200') {
            res.setHeader('content-type', 'application/json');
                res.statusCode = 200;
                res.json(buildResponse(false, 200, '', {
    ...
    // Gets a user
    app.get('/imperial/users', function (req, res, next) {
    ...
    // Projects ------------------------------
    // Create project
    app.post('/imperial/projects', function (req, res, next) {
    ...
    // List Projects
    app.get('/imperial/projects', function (req, res, next) {
        if (req.headers.authorization === 'auth200') {
            res.statusCode = 200;
            res.setHeader('content-type', 'application/json');
            res.json(listProjects.toObject());
    ...
    // Get a Project
    app.get('/imperial/projects/:code', function (req, res, next) {
        res.setHeader('content-type', 'application/json');
        if (req.headers.authorization === 'auth200') {
            res.statusCode = 200;
            res.json(listProjects.toObject());
    ...
    // Updates a Project
    app.put('/imperial/projects/:code', function (req, res, next) {
        res.setHeader('content-type', 'application/json');
        var projectData = req.body.data.items[0];
        if (req.headers.authorization === 'auth201') {
            res.statusCode = 201;
    ...
    // Deletes a Project
    app.delete('/imperial/projects/:code', function (req, res, next) {
        res.setHeader('content-type', 'application/json');
        if (req.headers.authorization === 'auth200') {
            res.statusCode = 200;
            res.json(buildResponse(false, 200, '', {
